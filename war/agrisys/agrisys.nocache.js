function agrisys(){
  ...
  if (!isHostedMode()) {
    try {
      ...
      unflattenKeylistIntoAnswers([$intern_62, $intern_53], $intern_65);
      unflattenKeylistIntoAnswers([$intern_62, $intern_52], $intern_65);
