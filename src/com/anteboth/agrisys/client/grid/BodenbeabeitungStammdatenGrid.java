...
import com.anteboth.agrisys.client.grid.data.BodenbearbeitungTypRecord;
 ...
 * @author michael
 */
public class BodenbeabeitungStammdatenGrid extends AbstractListGrid<BodenbearbeitungTypRecord> {
	 ...
	 * Constructor.
	 */
	public BodenbeabeitungStammdatenGrid() {
		super();
	}
	...
	protected void reloadData() {
		this.stammdatenManager.loadBodenbearbeitungStammdatenRecords(this);
	}
...
//		//save the record
//		stammdatenManager.save((BodenbearbeitungTypRecord) r, this);
//	}
	
	@Override
	public void startEditingNew() {		
		BodenbearbeitungTypRecord r = new BodenbearbeitungTypRecord(new BodenbearbeitungTyp());
		//save the record
	...
	@Override
	protected void deleteRecords(List<BodenbearbeitungTypRecord> records) {
		stammdatenManager.delete(records, BodenbeabeitungStammdatenGrid.this);
	}  
}